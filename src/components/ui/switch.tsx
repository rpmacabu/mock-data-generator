  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className="pointer-events-none block rounded-full bg-white shadow-[0_1px_3px_rgb(0_0_0/0.2)] ring-0 transition-transform duration-200 ease-out motion-reduce:transition-none group-data-[size=default]/switch:h-6 group-data-[size=default]/switch:w-9 group-data-[size=sm]/switch:h-5 group-data-[size=sm]/switch:w-6 data-unchecked:translate-x-0 group-data-[size=default]/switch:data-checked:translate-x-5.5 group-data-[size=sm]/switch:data-checked:translate-x-4"
      />
    </SwitchPrimitive.Root>
  );
}
